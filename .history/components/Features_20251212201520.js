        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            <p className="mt-5 text-justify md:max-w-[60%] md:text-center text-white/90">
              TaskGate is your personalized habit-building companion that helps you replace 
              impulsive scrolling with intentional actions. Customize your experience, track 
              your progress, and build lasting digital wellness habits that actually stick—one 
