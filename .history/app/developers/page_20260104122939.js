...
const sdks = [
  ...
  },
  {
    ...
    description:
      "Native iOS SDK for seamless TaskGate integration in your iOS applications. Supports iOS 13+ with Swift Package Manager.",
    icon: (
    ...
    installCommand: "https://github.com/task-gate/taskgate-sdk-ios.git",
  },
  {
    name: "Android SDK",
    ...
    installCommand: "implementation 'com.taskgate:sdk:latest'",
  },
];
